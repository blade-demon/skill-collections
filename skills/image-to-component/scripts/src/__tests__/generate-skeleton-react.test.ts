        ...
        rules: [
          {
            ...
            declarations: [
              { property: 'display', value: 'grid', source: 'inferred' },
              {
                ...
                value: 'var(--space-md)',
                source: 'token-ledger',
                comment: 'Confirmed spacing token',
              },
            ],
            variants: [
              {
    ...
    const styledConfig: SkeletonConfig = {
      ...
      stylePlan: {
        rules: [
          {
            component: 'RiskPage',
            declarations: [{ property: 'display', value: 'flex', source: 'inferred' }],
            variants: [],
          },
          {
            component: 'ActionBar',
            declarations: [{ property: 'justify-content', value: 'flex-end', source: 'inferred' }],
            variants: [],
          },
        ],
      },
