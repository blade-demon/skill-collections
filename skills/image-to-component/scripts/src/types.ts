...
export const SignatureObjectSchema = z
  .object({
...
export const CoarseImageResultSchema = z.object({
  ...
  coarse_signature: z
    .object({
      T: CoarseSignatureSlotSchema,
      M: CoarseSignatureSlotSchema,
      B: CoarseSignatureSlotSchema,
    })
    .strict(),
...
export const StyleDeclarationSchema = z
  .object({
    property: z.string().regex(/^(?:[a-z][a-z0-9-]*|--[a-z0-9-]+|-[a-z]+-[a-z0-9-]+)$/),
    value: z.string().min(1),
    source: z
      .enum(['inferred', 'token-ledger', 'token', 'hardcoded', 'provided', 'reused', 'create'])
      .default('inferred'),
    comment: z.string().optional(),
  })
  .strict();

export const StyleVariantRuleSchema = z
  .object({
...
export const ComponentStyleRuleSchema = z
  .object({
...
export const StylePlanSchema = z
  .object({
...
export const ComponentNodeSchema: z.ZodType<ComponentNode, z.ZodTypeDef, ComponentNodeInput> =
  z.lazy(() =>
    z.object({
