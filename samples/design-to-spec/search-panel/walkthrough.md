...
# OK: generated design spec at samples/design-to-spec/search-panel/design-spec/search-panel
```
...
这两条已经登记到 `skills/design-to-spec/references/roadmap.md`（V0.13+ 的 schema 演进话题），不阻塞本 sample 完成。
